      ...
      >
        <div style={{
          ...
          <div style={sectionStyle}>
            ...
            <ul style={{ ...contentStyle, paddingLeft: '24px', marginBottom: '16px' }}>
              <li style={listItemStyle}>Pose as another person or entity;</li>
              <li style={listItemStyle}>Access the Service from a different blockchain address if we've blocked any of your other blockchain addresses from accessing the Service, unless you have our written permission first;</li>
              <li style={listItemStyle}>Distribute spam, including sending unwanted links to other users;</li>
              <li style={listItemStyle}>Use the Service – including through disseminating any software or interacting with any API – that could damage, disable, overburden, or impair the functioning of the Service in any manner;</li>
              <li style={listItemStyle}>Bypass or ignore instructions that control access to the Service, including attempting to circumvent any rate-limiting systems by using multiple API keys, directing traffic through multiple IP addresses, or otherwise obfuscating the source of traffic you send to Share;</li>
              <li style={listItemStyle}>Use any data mining, robot, spider, crawler, scraper, script, browser extension, offline reader, or other automated means or interface not authorized by us to access the Service, extract data, or otherwise interfere with or modify the rendering of Service pages or functionality;</li>
              <li style={listItemStyle}>Reverse engineer, duplicate, decompile, disassemble, or decode any aspect of the Service, or do anything that might discover source code or bypass or circumvent measures employed to prevent or limit access to any service, area, or code of the Service;</li>
              <li style={listItemStyle}>Sell or resell the Service or attempt to circumvent any Formless fee systems;</li>
              <li style={listItemStyle}>Use the Service or data collected from our Service for any advertising or direct marketing activity (including without limitation, email marketing, SMS marketing, and telemarketing);</li>
              <li style={listItemStyle}>Use the Service for money laundering, terrorist financing, or other illicit finance;</li>
              <li style={listItemStyle}>Use the Service from a country sanctioned by the government of the United States or to facilitate transactions involving individuals sanctioned by the government of the United States or located in sanctioned countries;</li>
              <li style={listItemStyle}>Use the Service to carry out any financial activities subject to registration or licensing, including but not limited to creating, selling, or buying securities, commodities, options, or debt instruments;</li>
              <li style={listItemStyle}>Use the Service to create, sell, or buy NFTs or other items that give owners rights to participate in an ICO or any securities offering, or that are redeemable for securities, commodities, or other financial instruments;</li>
              <li style={listItemStyle}>Use the Service to engage in price manipulation, fraud, or other deceptive, misleading, or manipulative activity;</li>
              <li style={listItemStyle}>Use the Service to buy, sell, or transfer stolen items, fraudulently obtained items, items taken without authorization, and/or any other illegally obtained items;</li>
              <li style={listItemStyle}>Infringe or violate the intellectual property rights or any other rights of others;</li>
              <li style={listItemStyle}>Create or display illegal content, such as content that may involve child sexual exploitation;</li>
              <li style={listItemStyle}>Create or display smart contracts, or other items that promote suicide or self-harm, incite hate or violence against others, or doxes another individual;</li>
              <li style={listItemStyle}>Use the Service for any illegal or unauthorized purpose, including creating or displaying illegal content, such as content that may involve child sexual exploitation, or encouraging or promoting any activity that violates the Terms of Service;</li>
              <li style={listItemStyle}>Use the Service in any manner that could interfere with, disrupt, negatively affect or inhibit other users from fully enjoying the Service.</li>
            </ul>
            <p style={paragraphStyle}>
            ...
            <ul style={{ ...contentStyle, paddingLeft: '24px', marginBottom: '16px' }}>
              <li style={listItemStyle}>Explicit sexual content, including pornography, masturbation, and sex acts</li>
              <li style={listItemStyle}>Sexually suggestive content involving minors, including anime or stylized depictions</li>
              <li style={listItemStyle}>Violent, gory, or graphic content intended to shock or disturb</li>
              <li style={listItemStyle}>Non-consensual imagery, such as voyeuristic material</li>
              <li style={listItemStyle}>Hate speech, harassment, or targeted abuse</li>
              <li style={listItemStyle}>Illegal activities, including the promotion or depiction of drug use or criminal behavior</li>
            </ul>
            <p style={paragraphStyle}>
              If you believe that content violates our moderation policy, notify us directly via email at:{' '}
              <a
                href="mailto:moderation@formless.xyz"
                style={{
                  color: 'white',
          ...
          <div style={sectionStyle}>
            ...
            <h3 style={{ ...headingStyle, fontSize: 'clamp(15px, 1.4vw, 17px)', marginTop: '24px' }}>Copyrighted Works</h3>
            <p style={paragraphStyle}>
            ...
            <p style={paragraphStyle}>
              ...
              <a
                href="mailto:copyright@formless.xyz"
                style={{
                  color: 'white',
                  textDecoration: 'underline',
                  transition: 'opacity 0.3s ease',
            ...
            <ul style={{ ...contentStyle, paddingLeft: '24px', marginBottom: '16px' }}>
              <li style={listItemStyle}>Identification of the copyrighted work(s), trademark, publicity rights, or other intellectual property rights that you claim are being infringed;</li>
              <li style={listItemStyle}>Identification of the allegedly infringing material that is requested to be removed, including a description of the specific location (i.e., urls) on the Service of the material claimed to be infringing, so that we may locate the material;</li>
              <li style={listItemStyle}>Your contact information – at a minimum, your full legal name (not a pseudonym) and email address;</li>
              <li style={listItemStyle}>
                A declaration that contains all of the following:
                <ul style={{ paddingLeft: '24px', marginTop: '8px' }}>
                  <li style={{ marginBottom: '8px' }}>A statement that you have a good faith belief that the use of the material in the manner complained of is not authorized by the intellectual property rights owner, its agent, or the law;</li>
                  <li style={{ marginBottom: '8px' }}>A statement that the information in the notice is accurate; and</li>
                  <li style={{ marginBottom: '8px' }}>A statement under penalty of perjury that you are authorized to act on behalf of the intellectual property owner of the intellectual property that is allegedly being infringed.</li>
                </ul>
              </li>
              <li style={listItemStyle}>Your physical or electronic signature (of your full legal name).</li>
            </ul>
            <p style={paragraphStyle}>
          ...
          <div style={sectionStyle}>
            ...
            <ul style={{ ...contentStyle, paddingLeft: '24px', marginBottom: '16px' }}>
              <li style={listItemStyle}>The value of digital content is subjective. Prices for accessing content are subject to volatility and fluctuations in the price of cryptocurrency and materially affect the prices. You acknowledge that you fully understand this subjectivity and volatility.</li>
              <li style={listItemStyle}>We do not control the price of smart contract digital content or the time it is available. Pricing and access grant times are independently determined by content creators and can vary widely. You acknowledge that you fully understand this.</li>
              <li style={listItemStyle}>The regulatory regime governing blockchain technologies, smart contracts, cryptocurrency, and other crypto-based items is uncertain, and new regulations or policies may materially adversely affect the development of the Service.</li>
              <li style={listItemStyle}>You are solely responsible for determining what, if any, taxes apply to your transactions. Formless is not responsible for determining the taxes that apply to your sales.</li>
              <li style={listItemStyle}>There are risks associated with purchasing items associated with content created by third parties through peer-to-peer transactions, including but not limited to, the risk of purchasing counterfeit items, mislabeled items, items that are vulnerable to metadata decay, items on smart contracts with bugs, and items that may become untransferable. You represent and warrant that you have done sufficient research before making any decisions to sell, pay for, or otherwise interact with any smart contracts, or collections.</li>
              <li style={listItemStyle}>We do not control the public blockchains that you are interacting with and we do not control certain smart contracts and protocols that may be integral to your ability to complete transactions on these public blockchains. Additionally, blockchain transactions are irreversible, and Formless has no ability to reverse any transactions on the blockchain.</li>
              <li style={listItemStyle}>There are risks associated with using Internet and blockchain-based products, including, but not limited to, the risk associated with hardware, software, and Internet connections, the risk of malicious software introduction, and the risk that third parties may obtain unauthorized access to your third-party wallet or Account. You accept and acknowledge that Formless will not be responsible for any communication failures, disruptions, errors, distortions, or delays you may experience when using the Service or any Blockchain network, however caused.</li>
              <li style={listItemStyle}>The Service relies on third-party platforms and/or vendors. If we are unable to maintain a good relationship with such platform providers and/or vendors; if the terms and conditions or pricing of such platform providers and/or vendors change; if we violate or cannot comply with the terms and conditions of such platforms and/or vendors; or if any of such platforms and/or vendors lose market share or falls out of favor or is unavailable for a prolonged period of time, access to and use of the Service will suffer.</li>
              <li style={listItemStyle}>Formless reserves the right to hide collections, contracts, and items affected by any of these issues or by other issues. Items you purchase may become inaccessible on Share. Under no circumstances shall the inability to view items on Share or an inability to use the Service in conjunction with the purchase, sale, or transfer of items available on any blockchains serve as grounds for a claim against Formless.</li>
              <li style={listItemStyle}>If you have a dispute with one or more users, YOU RELEASE US FROM CLAIMS, DEMANDS, AND DAMAGES OF EVERY KIND AND NATURE, KNOWN AND UNKNOWN, ARISING OUT OF OR IN ANY WAY CONNECTED WITH SUCH DISPUTES. IN ENTERING INTO THIS RELEASE YOU EXPRESSLY WAIVE ANY PROTECTIONS (WHETHER STATUTORY OR OTHERWISE) THAT WOULD OTHERWISE LIMIT THE COVERAGE OF THIS RELEASE TO INCLUDE THOSE CLAIMS WHICH YOU MAY KNOW OR SUSPECT TO EXIST IN YOUR FAVOR AT THE TIME OF AGREEING TO THIS RELEASE.</li>
            </ul>
          </div>
          ...
          <div style={sectionStyle}>
            ...
            <p style={paragraphStyle}>
              ...
              {' '}for information about how we collect, use, and share data about you. By submitting data through our Service, you agree to the terms of our Privacy Policy and you expressly consent to the collection, use, and disclosure of your data in accordance with the Privacy Policy.
            </p>
          </div>
