...
const ApiDocs = () => {
  ...
  const handleOpenInChatGPT = () => {
    const pageContent = encodeURIComponent(window.location.href);
    window.open(`https://chat.openai.com/?q=${pageContent}`, '_blank');
    setCopyDropdownOpen(null);
  };

  const handleOpenInClaude = () => {
    const pageContent = encodeURIComponent(window.location.href);
    window.open(`https://claude.ai/new?q=${pageContent}`, '_blank');
    setCopyDropdownOpen(null);
  };

  const handleOpenInPerplexity = () => {
    const pageContent = encodeURIComponent(window.location.href);
    window.open(`https://perplexity.ai/search?q=${pageContent}`, '_blank');
    setCopyDropdownOpen(null);
  };
            ...
            <div style={{ position: 'relative' }}>
              ...
              {copyDropdownOpen === 'welcome' && (
                <div style={{
                  ...
                  <button className="dropdown-item" onClick={() => handleCopyPage('page')} style={{ display: 'flex', alignItems: 'center', gap: '12px', width: '100%', padding: '10px 16px', background: 'none', border: 'none', color: theme.text, fontSize: '14px', cursor: 'pointer', textAlign: 'left' }}>
                  ...
                  <button className="dropdown-item" onClick={() => handleViewAsMarkdown()} style={{ display: 'flex', alignItems: 'center', gap: '12px', width: '100%', padding: '10px 16px', background: 'none', border: 'none', color: theme.text, fontSize: '14px', cursor: 'pointer', textAlign: 'left' }}>
                  ...
                  <button className="dropdown-item" onClick={handleOpenInChatGPT} style={{ display: 'flex', alignItems: 'center', gap: '12px', width: '100%', padding: '10px 16px', background: 'none', border: 'none', color: theme.text, fontSize: '14px', cursor: 'pointer', textAlign: 'left' }}>
                  ...
                  <button className="dropdown-item" onClick={handleOpenInClaude} style={{ display: 'flex', alignItems: 'center', gap: '12px', width: '100%', padding: '10px 16px', background: 'none', border: 'none', color: theme.text, fontSize: '14px', cursor: 'pointer', textAlign: 'left' }}>
                  ...
                  <button className="dropdown-item" onClick={handleOpenInPerplexity} style={{ display: 'flex', alignItems: 'center', gap: '12px', width: '100%', padding: '10px 16px', background: 'none', border: 'none', color: theme.text, fontSize: '14px', cursor: 'pointer', textAlign: 'left' }}>
